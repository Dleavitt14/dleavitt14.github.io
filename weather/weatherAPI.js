...
(function () {
    ...
    var status = document.getElementById('title-large');
    ...
    function getData(lat, long) {
        ...
        getJSON(url).then(function (data) {
            ...
            document.getElementById("center").innerHTML = data.location.city + ", " + data.location.state + " Mobile Weather App | Home Weather | Weather data";
            document.getElementById("center1").innerHTML = data.location.city + ", " + data.location.state;
            document.getElementById("center2").innerHTML = data.current_observation.temp_f.toFixed(0) + "&degF";
            ...
            document.getElementById("prec").innerHTML = data.current_observation.precip_today_string;
