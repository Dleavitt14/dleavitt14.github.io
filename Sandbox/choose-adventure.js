// I worked with the guy that sits next to me. I think his first name is cory, but I'm not sure.
...
function nextStep(id) {
    ...
    updateElement('ending', instruction.ending);
...
function updateElement (id, replacment) {
    document.getElementById(id).innerHTML = replacment;
}
